...
var BlogListComponent = /** @class */ (function () {
    ...
    BlogListComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.tag = params.get('tag');
            if (_this.tag) {
                _this.filteredBlogs = _this.blogService.getBlogsByTag(_this.tag);
            }
            else {
                _this.blogService.getBlogs().subscribe(function (blogs) {
                    _this.filteredBlogs = blogs;
                });
            }
        });
    };
